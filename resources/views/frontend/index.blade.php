        ...
        <section class="call-to-action with-borders with-button-arrow mb-3 mt-3">
            <div class="col-sm-9 col-lg-9">
                <div class="call-to-action-content">
                    <h3>BM Çevre - 
                        <strong class="font-weight-extra-bold">Doğaya Saygı, Temiz Suya Bağlılık</strong>
                    </h3>
                    <p class="mb-0">Çevreye duyarlı su arıtma çözümlerimizle hem doğayı koruyor hem de suyun yeniden kullanılabilir hale gelmesini sağlıyoruz.</p>
                </div>
            </div>
