<div id="home" class="owl-carousel owl-carousel-light owl-carousel-light-init-fadeIn owl-theme manual dots-inside dots-horizontal-center show-dots-hover show-dots-xs dots-light nav-style-1 nav-inside nav-inside-plus nav-light nav-md nav-font-size-md show-nav-hover mb-0" data-plugin-options="{'autoplayTimeout': 7000}" style="height: 100vh;">
    <div class="owl-stage-outer">
        <div class="owl-stage">
            ...
            <div class="owl-item position-relative overlay overlay-show overlay-op-5" style="background-image: url(/banner1.jpg); background-size: cover; background-position: center;">
            ...
            <div class="owl-item position-relative overlay overlay-show overlay-op-5" style="background-image: url(/banner2.jpg); background-size: cover; background-position: center;">
                <div class="container position-relative z-index-3 h-100">
                    <div class="row justify-content-center align-items-center h-100">
                        <div class="col-lg-10 text-center">
                            <div class="d-flex flex-column align-items-center justify-content-center h-100">
        ...
        <div class="row align-items-center">
            <div class="col-md-6 col-lg-7">
                <div class="looking-for-box">
                    <h2>- <span class="text-1 custom-secondary-font">Sağlıklı Yaşam İçin Temiz Su
                    </span></h2>
                    <p class="text-white">İnsan sağlığını ve doğayı ön planda tutarak, atık suları güvenilir bir şekilde temizleyip doğaya kazandırıyoruz.</p>
                </div>
            </div>
